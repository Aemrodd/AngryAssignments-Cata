...
function AngryAssign:UpdateDisplayed()
	...
	if page then
		...
		text = text:gsub("||", "|")
			...
			:gsub(ci_pattern('|cdeathknight'), "|cffc41e3a")
			:gsub(ci_pattern('|cdruid'), "|cffff7c0a")
			:gsub(ci_pattern('|chunter'), "|cffaad372")
			:gsub(ci_pattern('|cmage'), "|cff3fc7eb")
			:gsub(ci_pattern('|cpaladin'), "|cfff48cba")
			:gsub(ci_pattern('|cpriest'), "|cffffffff")
			:gsub(ci_pattern('|crogue'), "|cfffff468")
			:gsub(ci_pattern('|cshaman'), "|cff0070dd")
			:gsub(ci_pattern('|cwarlock'), "|cff8788ee")
			:gsub(ci_pattern('|cwarrior'), "|cffc69b6d")
